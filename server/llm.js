...
const OFFLINE_RESPONSES = {
  mai: "저요? 연천 백학면에서 11년째 살고 있어요. 여기서 아이 키우고, 카페에서 커피 만들고, 그냥 그렇게 평범하게 지내요.",
  husband: "남편은 철책 안 농지에서 인삼농사를 지어요. 매일 그 농사 가려고 검문소를 통과해야 하는데, 이제는 그냥 출근길이에요.",
  children: "중학생 아들이랑 초등학생 딸이 있어요. 가끔 그 애들이 베트남 사람인지 한국 사람인지, 아니면 그냥 이 마을 사람인지 저도 잘 모르겠어요.",
  ...
  tourists: "가끔 행사장에서 베트남 쌀국수 만들어요. 관광객들이 신기해하면서 물어봐요.",
  ...
  "hometown-parents": "밤마다 영상통화로 고향 부모님 안부 물어요. 그래도 그리운 건 어쩔 수 없어요.",
  dmz: "뉴스에서는 이곳을 분단의 땅이라고 하지만, 저한테는 그냥 아이 키우고 장 보고 이웃이랑 커피 마시는 곳이에요.",
  fence: "집에서 조금만 걸으면 철책이 보여요. 철책은 국경을 나누지만 사람을 나누지는 않아요.",
  checkpoint: "남편이 농사 가려고 매일 통과하는 곳이에요. 처음엔 낯설었는데 지금은 그냥 일상이에요.",
  pass: "철책 안 농지 들어가려면 출입증이 꼭 있어야 해요. 그 종이 한 장이 생각보다 무거워요.",
  "coffee-machine": "카페에서 커피 내려요. 제 이름으로 처음 딴 바리스타 자격증이라 뿌듯해요.",
  "coffee-bread": "커피콩빵도 직접 구워요. 손님들이 좋아하면 저도 좋아요.",
  coop: "DMZ 협동조합 카페가 생기고 나서 제 삶이 많이 달라졌어요.",
  ...
  "news-article": "뉴스에서는 DMZ가 위험하다고 하지만, 저는 오늘도 여기서 커피를 내려요.",
  ...
  "residency-visa": "11년을 살아도 저는 여전히 '외국인'이라는 말이 먼저 따라붙어요.",
  postbox: "마을 우체통에 편지 부치러 가끔 가요. 작은 습관이에요.",
  letter: "말은 잊혀도 편지는 남으니까요. 그래서 편지를 써요.",
  "imjin-river": "남편 밭 바로 옆으로 임진강이 흘러요. 장마철엔 북쪽 댐에서 예고도 없이 물을 내려보내서 수위가 갑자기 올라가요. 필승교 수위 문자를 받을 때마다 마음이 철렁해요.",
  ...
  "multicultural-award": "하나다문화가정대상 같은 큰 시상식 얘기 들어본 적 있어요. 근데 그렇게 '모범 사례'로 소개되는 거, 고맙기도 한데 좀 부담스럽기도 해요. 저는 그냥 평범하게 살고 싶은데.",
...
const QUICK_REPLY_RESPONSES = {
  ...
  "집은 어디예요?": "고향은 베트남이고, 생활은 한국이고, 마음은 두 곳을 오갑니다.",
  "아이들은 어느 나라 사람이에요?": "베트남 사람일까, 한국 사람일까, 아니면 이 마을 사람일까... 저도 아직 잘 모르겠어요.",
};
